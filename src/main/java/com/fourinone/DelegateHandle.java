...
public class DelegateHandle implements InvocationHandler {
	...
	/*
	 * public static <I> I bind(Class<I>[] a, Class b) { return
	 * (I)Proxy.newProxyInstance(a[0].getClassLoader(), a, new
	 * DelegateHandle(b));//new Class[] }
	 */
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		/*
		 * if(method.getName().equals("getStr")) result =
		 * (Object)ClientMain.getStrUtil((String)args[0]); else
		 * if(method.getName().equals("getSomething")) result =
		 * method.invoke(new ClientMain(), args);
